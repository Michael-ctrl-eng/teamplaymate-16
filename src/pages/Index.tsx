...
import { Globe, ChevronDown, Star, Users, BarChart3, Wifi, FileText, ArrowRight, Play, Zap, Shield, Target, X, Maximize2, Volume2, VolumeX } from 'lucide-react';
      ...
      >
        ...
        >
          <Button
            ...
            className="rounded-full p-3 backdrop-blur-md border-2 transition-all duration-300 bg-black/20 border-gray-600 text-white hover:bg-gray-800/50 hover:border-gray-500"
          >
